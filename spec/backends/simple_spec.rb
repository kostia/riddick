...
describe Riddick::Backend::Simple do
  describe 'creating a new backend' do
    it 'should store i18n backend' do
      i18n_be = mock
      Riddick::Backend::Simple.new(i18n_be).i18n_backend.should == i18n_be
    end
  end
  ...
  describe '#translations' do
    it 'should return normalized translation from i18n backend' do
      ...
      Riddick::Backend::Simple.new(i18n_be).translations.should == {'en.foo.bar' => 'baz'}
    end
  end
  ...
  describe '#init_translations' do
    it 'should init translations of i18n backend' do
      ...
      Riddick::Backend::Simple.new(i18n_be).init_translations
    end
  end
end
